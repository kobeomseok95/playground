...
public class QTakenSeat extends EntityPathBase<TakenSeat> {
    ...
    public final com.example.solid.modules.voucher.domain.QMemberVoucher memberVoucher;
    ...
    public QTakenSeat(Class<? extends TakenSeat> type, PathMetadata metadata, PathInits inits) {
        ...
        this.memberVoucher = inits.isInitialized("memberVoucher") ? new com.example.solid.modules.voucher.domain.QMemberVoucher(forProperty("memberVoucher"), inits.get("memberVoucher")) : null;
